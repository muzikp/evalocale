...
| ***closest*** | Returns the key of a dictionary that is closest to the specified value. If no similar language is found, returns either the default or the system language. | what | | String / Object | true | | Either a string (eg "en-NZ") or an object (eg {code: "en", region: "NZ", script: "en"}) |
